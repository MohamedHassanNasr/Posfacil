...
@AndroidEntryPoint
class MainXActivity : BaseActivity() {
        ...
        viewPager2.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
            override fun onPageSelected(position: Int) {
                ...
                when {
                    position % 3 == 0 -> {
                        binding.txtOnBoardingTitle.text = ApplicationClass.language.textSplashOne
                        binding.pointTwo.setBackgroundColor(this@MainXActivity.resources.getColor(R.color.white))
                        binding.pointThird.setBackgroundColor(this@MainXActivity.resources.getColor(R.color.white))
                    }
                    position % 3 == 1 -> {
                        binding.txtOnBoardingTitle.text = ApplicationClass.language.textSplashTwo
                        binding.pointTwo.setBackgroundColor(this@MainXActivity.resources.getColor(R.color.greenLight))
                        binding.pointThird.setBackgroundColor(this@MainXActivity.resources.getColor(R.color.white))
                    }
                    position % 3 == 2 -> {
                        binding.txtOnBoardingTitle.text = ApplicationClass.language.textSplashThree
                        binding.pointTwo.setBackgroundColor(this@MainXActivity.resources.getColor(R.color.greenLight))
                        binding.pointThird.setBackgroundColor(this@MainXActivity.resources.getColor(R.color.greenLight))
                    }
                }
